...
```{r}
result = fread(paste(result.folder, "combined_multivariable_M18_nochangedosage_Sensitivity Day30.csv", sep=''))
```
...
ggsave(paste(result.folder,'Dosage_M18_nodosagechange_Sensitivity Day30.svg', sep=''), plot=forestplot, width = 8, height = 12)
```
