...
```{r}
result = fread(paste(result.folder, "combined_multivariable_M18_nochangedosage.csv", sep=''))
```
...
ggsave(paste(result.folder,'Dosage_M18_nodosagechange.svg', sep=''), plot=forestplot, width = 8, height = 12)
```
