---
title: "Data preparation for regression analysis_Sensitivity 7 days"
author: "Huiru Dong"
date: "2024-04-29"
...
RX_episode = fread(paste(dat.folder,"episodes_RX_with_max_dosage_M18_Sensitivity Day7.csv", sep=''))
...
# 4695 episodes with max dosage >40 due to overlapping days
nrow(check2)
# 170706 rows
```
...
# 1700307
```
After sample restriction (Apr 1), we have 1700307 episodes 14035921 records
...
fwrite(episode.mod4, paste(dat.folder,"Model data_18M_Sensitivity Day7.csv", sep=''))
# 1,690,950
