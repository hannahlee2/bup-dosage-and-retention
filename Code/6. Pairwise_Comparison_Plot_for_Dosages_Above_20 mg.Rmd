...
```{r}
# Read in the data
dat = fread(paste(result.folder, "pairwise_multivariable_M18_nochangedosage_cleaned_revision.xlsx", sep=''))
dat <- pairwise_multivariable_M18_nochangedosage_cleaned_revision
```
